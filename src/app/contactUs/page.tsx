...
function MyComponent() {
    ...
    return (
        <div className='contact us'>
            ...
            <div className="flex items-start justify-start min-h-screen mt-9 ml-20 space-x-40 ">
            <div className="w-96">
            <form onSubmit={handleSubmit}>
                <Input type="text" placeholder="Name" className="mb-4" />
                <Input type="email" placeholder="Email" className="mb-4" onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEmail(e.target.value)} />
                <Input type="number" placeholder="Phone Number" className="mb-4" />
                <Input type="text" placeholder="Messages" className="mb-4" />
