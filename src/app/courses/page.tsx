...
export default function TestPage(){
    return (
        <div className="landingpage flex flex-col">
            <NavigationBar />
            <div className="w-screen h-screen flex lg:items-center lg:justify-center flex-col">
                <div className="w-screen h-2/5 lg:h-1/2 bg-[url('./images/courses1.png')] bg-cover bg-center flex items-center justify-center">
                    <h1 className="text-white font-extrabold text-4xl md:text-5xl">Courses</h1>
                </div>
                <div className="w-screen h-3/5 lg:h-1/2 text-center space-y-5 md:space-y-10 lg:w-screen max-w-4xl ">
                    <h1 className=" text-lg md:text-4xl font-bold text-black pt-5 md:pt-14 lg:text-3xl lg:pt-12">Welcome to iBEST INSTITUTE</h1>
                    <p className=" text-base md:text-2xl text-black m-10 lg:text-xl">One of Bhutan's elite, QMS-certified training hubs, recognized by the Ministry of Labour and Human Resources. Our expert-led courses aren’t just about knowledge, they’re about real-world impact. We break the boundaries of traditional learning, taking you beyond the classroom for hands-on, next-level skills.</p>
                    <p className="text-base font-semibold md:text-2xl text-black m-5 md:m-12 lg:text-xl ">
            ...
            <div className="w-screen h-screen flex item-center justify-center">
                <div className="h-screen w-5/6 flex flex-col space-y-3 md:space-y-7 items-center justify-center">
                    <div className="w-full h-14 md:h-20 lg:w-1/2 bg-lightBlue rounded relative flex items-center justify-center drop-shadow-md hover:drop-shadow-xl">
            ...
            <div className="w-screen h-screen flex flex-col lg:flex-row">
                ...
                <div className="w-11/12 h-5/6 bg-gradient-to-br from-gray-50 to-gray-200 rounded-xl p-6 lg:p-8 flex flex-row lg:flex-col items-center justify-center drop-shadow-lg hover:drop-shadow-2xl border border-slate-300 hover:border-indigo-300 transition-all duration-300 ease-in-out">
                    <div className="w-2/6 h-full lg:h-2/5 lg:w-full flex flex-col space-y-3 items-center justify-center">
                        ...
                        <div className="w-4/6 lg:w-11/12 h-full bg-gray-100 rounded-lg  md:p-4 lg:p-6 space-y-1 md:space-y-3 lg:space-y-5 lg:h-3/5">
                            <h1 className="font-extrabold text-sm md:text-4xl text-indigo-700 pl-2 lg:text-3xl">Life Skills Courses</h1>
                            <p className="font-medium text-xs md:text-xl lg:text-lg pl-2 text-gray-700">What You'll Learn:</p>
                            <ul className="list-none text-xs md:text-lg md:space-y-3 lg:space-y-4">
                ...
                <div className="w-11/12 h-5/6 bg-gradient-to-br from-gray-50 to-gray-200 rounded-xl p-6 lg:p-8 flex flex-row lg:flex-col items-center justify-center drop-shadow-lg hover:drop-shadow-2xl border border-slate-300 hover:border-indigo-300 transition-all duration-300 ease-in-out">
                    <div className="w-2/6 h-full lg:h-2/5 lg:w-full flex flex-col space-y-3 items-center justify-center">
                        ...
                        <div className="w-4/6 lg:w-11/12 h-full bg-gray-100 rounded-lg  md:p-4 lg:p-6 space-y-2 lg:space-y-5 lg:h-3/5">
                            <h1 className="font-extrabold text-sm md:text-4xl text-indigo-700 pl-2 lg:text-3xl">Leadership Courses</h1>
                            <p className="font-medium text-sm md:text-xl lg:text-lg pl-2 text-gray-700">What You'll Learn:</p>
                            <ul className="list-none text-xs md:text-base md:space-y-3 lg:space-y-4">
            ...
            <div className="w-screen h-screen flex flex-col lg:flex-row">
                ...
                <div className="w-11/12 h-5/6 bg-gradient-to-br from-gray-50 to-gray-200 rounded-xl p-6 lg:p-8 flex flex-row lg:flex-col items-center justify-center drop-shadow-lg hover:drop-shadow-2xl border border-slate-300 hover:border-indigo-300 transition-all duration-300 ease-in-out">
                    <div className="w-2/6 h-full lg:h-2/5 lg:w-full flex flex-col space-y-3 items-center justify-center">
                        ...
                        <div className="w-4/6 lg:w-11/12 h-full bg-gray-100 rounded-lg  md:p-4 lg:p-6 space-y-1 md:space-y-3 lg:space-y-5 lg:h-3/5">
                            <h1 className="font-extrabold text-sm md:text-4xl text-indigo-700 pl-2 lg:text-3xl">Management Courses</h1>
                            <p className="font-medium text-xs md:text-xl lg:text-lg pl-2 text-gray-700">What You'll Learn:</p>
                            <ul className="list-none text-xs md:text-lg md:space-y-3 lg:space-y-4">
                ...
                <div className="w-11/12 h-5/6 bg-gradient-to-br from-gray-50 to-gray-200 rounded-xl p-6 lg:p-8 flex flex-row lg:flex-col items-center justify-center drop-shadow-lg hover:drop-shadow-2xl border border-slate-300 hover:border-indigo-300 transition-all duration-300 ease-in-out">
                    <div className="w-2/6 h-full lg:h-2/5 lg:w-full flex flex-col space-y-3 items-center justify-center">
                        ...
                        <div className="w-4/6 lg:w-11/12 h-full bg-gray-100 rounded-lg  md:p-4 lg:p-6 space-y-2 lg:space-y-5 lg:h-3/5">
                            <h1 className="font-extrabold text-sm md:text-4xl text-indigo-700 pl-2 lg:text-3xl">Accounting and Financial Courses</h1>
                            <p className="font-medium text-xs md:text-xl lg:text-lg pl-2 text-gray-700">What You'll Learn:</p>
                            <ul className="list-none text-xs md:text-base md:space-y-3 lg:space-y-4">
            ...
            <div className="w-screen h-screen flex flex-col lg:flex-row">
                ...
                <div className="w-11/12 h-5/6 bg-gradient-to-br from-gray-50 to-gray-200 rounded-xl p-6 lg:p-8 flex flex-row lg:flex-col items-center justify-center drop-shadow-lg hover:drop-shadow-2xl border border-slate-300 hover:border-indigo-300 transition-all duration-300 ease-in-out">
                    <div className="w-2/6 h-full lg:h-2/5 lg:w-full flex flex-col space-y-3 items-center justify-center">
                        ...
                        <div className="w-4/6 lg:w-11/12 h-full bg-gray-100 rounded-lg  md:p-4 lg:p-6 space-y-1 md:space-y-3 lg:space-y-5 lg:h-3/5">
                            <h1 className="font-extrabold text-sm md:text-4xl text-indigo-700 pl-2 lg:text-3xl">Entrepreneurship Courses</h1>
                            <p className="font-medium text-xs md:text-xl lg:text-lg pl-2 text-gray-700">What You'll Learn:</p>
                            <ul className="list-none text-xs md:text-lg md:space-y-3 lg:space-y-4">
                ...
                <div className="w-11/12 h-5/6 bg-gradient-to-br from-gray-50 to-gray-200 rounded-xl p-6 lg:p-8 flex flex-row lg:flex-col items-center justify-center drop-shadow-lg hover:drop-shadow-2xl border border-slate-300 hover:border-indigo-300 transition-all duration-300 ease-in-out">
                    <div className="w-2/6 h-full lg:h-2/5 lg:w-full flex flex-col space-y-3 items-center justify-center">
                        ...
                        <div className="w-4/6 lg:w-11/12 h-full bg-gray-100 rounded-lg  md:p-4 lg:p-6 space-y-2 lg:space-y-5 lg:h-3/5">
                            <h1 className="font-extrabold text-sm md:text-4xl text-indigo-700 pl-2 lg:text-3xl">Multimedia Courses</h1>
                            <p className="font-medium text-sm md:text-xl lg:text-lg pl-2 text-gray-700">What You'll Learn:</p>
                            <ul className="list-none text-xs md:text-base md:space-y-3 lg:space-y-4">
            ...
            <div className="w-screen h-screen flex flex-col lg:flex-row">
                ...
                <div className="w-11/12 h-5/6 bg-gradient-to-br from-gray-50 to-gray-200 rounded-xl p-6 lg:p-8 flex flex-row lg:flex-col items-center justify-center drop-shadow-lg hover:drop-shadow-2xl border border-slate-300 hover:border-indigo-300 transition-all duration-300 ease-in-out">
                    <div className="w-2/6 h-full lg:h-2/5 lg:w-full flex flex-col space-y-3 items-center justify-center">
                        ...
                        <div className="w-4/6 lg:w-11/12 h-full bg-gray-100 rounded-lg  md:p-4 lg:p-6 space-y-1 md:space-y-3 lg:space-y-5 lg:h-3/5">
                            <h1 className="font-extrabold text-sm md:text-4xl text-indigo-700 pl-2 lg:text-3xl">Film Studies Courses</h1>
                            <p className="font-medium text-xs md:text-xl lg:text-lg pl-2 text-gray-700">What You'll Learn:</p>
                            <ul className="list-none text-xs md:text-lg md:space-y-3 lg:space-y-4">
                ...
                <div className="w-11/12 h-5/6 bg-gradient-to-br from-gray-50 to-gray-200 rounded-xl p-6 lg:p-8 flex flex-row lg:flex-col items-center justify-center drop-shadow-lg hover:drop-shadow-2xl border border-slate-300 hover:border-indigo-300 transition-all duration-300 ease-in-out">
                    <div className="w-2/6 h-full lg:h-2/5 lg:w-full flex flex-col space-y-3 items-center justify-center">
                        ...
                        <div className="w-4/6 lg:w-11/12 h-full bg-gray-100 rounded-lg  md:p-4 lg:p-6 space-y-2 lg:space-y-5 lg:h-3/5">
                            <h1 className="font-extrabold text-sm    placeholder:       f md:text-4xl text-indigo-700 pl-2 lg:text-3xl">Technical and Engineering Courses</h1>
                            <p className="font-medium text-sm md:text-xl lg:text-lg pl-2 text-gray-700">What You'll Learn:</p>
                            <ul className="list-none text-xs md:text-base md:space-y-3 lg:space-y-4">
            ...
            <div className="w-screen h-screen flex flex-col lg:flex-row items-center justify-center">
                ...
                <div className="w-11/12 h-5/6 bg-gradient-to-br from-gray-50 to-gray-200 rounded-xl p-6 lg:p-8 flex flex-row lg:flex-col items-center justify-center drop-shadow-lg hover:drop-shadow-2xl border border-slate-300 hover:border-indigo-300 transition-all duration-300 ease-in-out">
                    <div className="w-2/6 h-full lg:h-2/5 lg:w-full flex flex-col space-y-3 items-center justify-center">
                        ...
                        <div className="w-4/6 lg:w-11/12 h-full bg-gray-100 rounded-lg  md:p-4 lg:p-6 space-y-1 md:space-y-3 lg:space-y-5 lg:h-3/5">
                            <h1 className="font-extrabold text-sm md:text-4xl text-indigo-700 pl-2 lg:text-3xl">ICT Courses</h1>
                            <p className="font-medium text-xs md:text-xl lg:text-lg pl-2 text-gray-700">What You'll Learn:</p>
                            <ul className="list-none text-xs md:text-lg md:space-y-3 lg:space-y-4">
